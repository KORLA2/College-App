  ...
  return (
    <Router>
      <Routes>
        ...
        <Route path="/student" element={<Student student={student} setimage={setimage} setstudent={setstudent}/>} />
        <Route path="/admin" element={<Admin />}></Route>
        <Route path="/admin/register" element={<Register />} />
        <Route path="/admin/Add Student" element={<Addstudent />} />
        <Route path="/admin/All Students" element={<AllStudents />} />
        <Route path="/student/View Profile" element={<ViewProfile student={student} image={image} />} />
      </Routes>
    </Router>
  );
}
